...
export default function FormularioCadastroServico({ atualizarInterface }: { atualizarInterface?: () => void }) {
  ...
  const handleSubmit = useCallback(async (event: React.FormEvent) => {
    ...
    try {
      ...
      const novoServico = { nome: state.nome, preco: precoNumerico };
      ...
      setState(prev => ({
        ...prev,
        mensagem: `Serviço ${state.nome} cadastrado com sucesso!`,
